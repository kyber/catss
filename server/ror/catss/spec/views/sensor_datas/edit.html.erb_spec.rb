...
describe "sensor_datas/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit sensor_data form" do
    render

    response.should have_selector("form", :action => sensor_data_path(@sensor_data), :method => "post") do |form|
